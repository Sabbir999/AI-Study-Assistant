...
import PaymentSuccess from "./mainpages/PaymentSuccess";
        ...
        <div className="content">
          <Routes>
            ...
            <Route path="/Open" element={<Open />} />
              <Route 
                path="/Dashboard" 
                element={<Dashboard currentUser={currentUser} setSidebarOpen={setSidebarOpen} />}
              />
              <Route path="/Dashboard/flashcards" element={<Flashcards currentUser={currentUser} />} />
              <Route path="/Dashboard/createflashcards" element={<CreateFlashcards currentUser={currentUser} />} />
              <Route path="/Dashboard/createflashcards/:listId" element={<CreateFlashcards currentUser={currentUser} />} />
              <Route path="/Dashboard/aiflashcards" element={<AIFlashcards currentUser={currentUser} />} />
              <Route path="/Dashboard/flashcards/:listId" element={<ViewFlashcards currentUser={currentUser} />} />
              <Route path="/Dashboard/summarizer" element={<Summarizer />} />
              <Route path="/Quizzes" element={<Quizzes currentUser={currentUser} />} />
              <Route path="/quizzes/:quizId?" element={<Quizzes currentUser={currentUser} />} />
              <Route path="/ForgotPassword" element={<ForgotPassword />} />
              <Route path="/" element={<Home />} />
              <Route path="/Games" element={<Games />} />
              <Route path="/CategorySortingGame" element={<CategorySortingGame currentUser={currentUser} />} />
              <Route path="/Country" element={<CountryGame />} />
              <Route path="/CrossWord" element={<div>CrossWord Puzzle Coming Soon</div>} />
              <Route path="/FactGame" element={<FactGame />} />
              <Route path="/QuizHistory" element={<QuizHistory currentUser={currentUser} />} />
              <Route path="/Notes" element={<Notes currentUser={currentUser} />} />
              <Route 
                path="/StudyPlanner" 
                element={currentUser ? <StudyPlanner userId={currentUser.uid} /> : <div>Please log in to use the Study Planner.</div>} 
              />
